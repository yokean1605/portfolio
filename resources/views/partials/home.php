...
<section id="home" class="home d-flex align-items-center">
    <div class="container">
        <div class="intro">
            ...
            <img src="dist/images/profile.svg" alt="Profile" class="img-fluid mb-4">
            <h1 class="mb-2 mt-0">Yoke Andreian Yudistiro</h1>
            <!-- subtitles -->
            <span class="text-rotating js-rotating ">
                I am a Front End Developer, I am a Back End Developer
            </span>

            <!-- social media -->
        </div>
        <ul class="list-inline social-icon mb-0 mt-4 text-center">
    ...
    <div class="parallax" data-relative-input="true">
        ...
        <svg width="30" height="25" data-depth="0.3" class="layer p9" xmlns="http://www.w3.org/2000/svg">
